...
import getPort from 'super-project/utils/get-port'
// import getStore from '@utils/store'
// import { resetLogin } from '@api/user'

const apiBase = (() => {
    // if (__QA__) return 'https://toa.hiaiplus.com/'
    // if (__DEV__) return 'http://10.100.37.17:8099/'
    // return 'https://oa.hiaiplus.com/'
